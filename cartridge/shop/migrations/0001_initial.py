# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2020-11-08 15:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_type', models.CharField(blank=True, choices=[('ME', 'Membership'), ('DL', 'Download'), ('TK', 'Ticket'), ('SH', 'Shipping'), ('CO', 'Collect'), ('OT', 'Other'), ('EN', 'Entry')], default='', max_length=36)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('callback_uuid', models.CharField(blank=True, max_length=36)),
                ('product_type', models.CharField(blank=True, choices=[('ME', 'Membership'), ('DL', 'Download'), ('TK', 'Ticket'), ('SH', 'Shipping'), ('CO', 'Collect'), ('OT', 'Other'), ('EN', 'Entry')], default='', max_length=36)),
                ('admin', models.BooleanField(default=False)),
                ('paid', models.BooleanField(default=False)),
                ('username', models.CharField(blank=True, max_length=256)),
                ('user_email', models.EmailField(blank=True, max_length=256)),
                ...
                ('organisation', models.CharField(blank=True, max_length=256)),
                ('payment_type', models.CharField(blank=True, choices=[('BA', 'Bank Transfer'), ('PA', 'Paypal'), ('ST', 'Stripe')], default='', max_length=256)),
                ('payment_time', models.DateTimeField(blank=True, null=True)),
                ('abandoned', models.BooleanField(default=False, help_text="Removes order from Users Order History, shows as 'Abandoned' on reports. Ignored for Paid Orders")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_type', models.CharField(choices=[('ME', 'Membership'), ('DL', 'Download'), ('TK', 'Ticket'), ('SH', 'Shipping'), ('CO', 'Collect'), ('OT', 'Other'), ('EN', 'Entry')], default='', max_length=36)),
                ('stripe_pid', models.CharField(blank=True, max_length=36)),
                ('stripe_sku', models.CharField(blank=True, max_length=36)),
